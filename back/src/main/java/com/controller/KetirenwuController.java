    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(ketirenwu !=null){
            ...
            BeanUtils.copyProperties( ketirenwu , view );//把实体数据重构到view中
                ...
                //级联表
                ZhidaojiaoshiEntity jiaoshi = zhidaojiaoshiService.selectById(ketirenwu.getZhidaojiaoshiId());
                if(jiaoshi != null){
    ...
    */
    ...
    public R save(@RequestBody KetirenwuEntity ketirenwu, HttpServletRequest request){
        ...
        if(false)
            ...
            ketirenwu.setZhidaojiaoshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<KetirenwuEntity> queryWrapper = new EntityWrapper<KetirenwuEntity>()
            .eq("zhidaojiaoshi_id", ketirenwu.getZhidaojiaoshiId())
...
//                            ketirenwuEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //指导教师 要改的
...
//                            ketirenwuEntity.setKetirenwuYesnoText(data.get(0));                    //指导教师打分 要改的
